/*
Author: Eileen Campbell; Modified by Zineb Hassani
*/
(function($) {
  ...
  var freezerbox_methods = {
    ...
    init_fbinfo: function (set) {
      ...
      var fbinfo_flds = [
        ...
        {"text":"Name","name":"freezerbox_info_name_mandatory","set_key":"freezerbox","value":"","edit_html":'<input size="50" required="required" placeholder="Enter a name for this freezer box"/><span style="color:red">*</span>',"view_html":'<span/>'},
        ...
        {"text":"Box","name":"freezerbox_info_box","set_key":"box","value":"","edit_html":'<input size="50" placeholder="Enter a box location for this freezer box"/>',"view_html":'<span/>'},
        {"text":"Shelf","name":"freezerbox_info_shelf","set_key":"shelf","value":"","edit_html":'<input size="50" placeholder="Enter a shelf location for this freezer box"/>',"view_html":'<span/>'},
        {"text":"Rack","name":"freezerbox_info_rack","set_key":"rack","value":"","edit_html":'<input size="50" placeholder="Enter a rack location for this freezer box"/>',"view_html":'<span/>'},
    ...
    import_json: function(json_data) {
      var fbinfo_flds = {
        "freezerbox_info_name_mandatory":"FreezerBox", //modified
        "freezerbox_info_size":"size",
        "freezerbox_info_color":"color",
        "freezerbox_info_shelf":"shelf", //modified
        "freezerbox_info_rack":"rack", //modified
        "freezerbox_info_box":"box", //modified
